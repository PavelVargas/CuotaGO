...
class OrganizationSubscription(db.Model):
    ...
    billing_lock_enabled = db.Column(db.Boolean, nullable=False, default=False)
    billing_lock_started_at = db.Column(db.DateTime)
    billing_lock_by_user_id = db.Column(db.Integer)
